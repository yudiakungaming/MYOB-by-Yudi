...
export interface InventoryItem {
  ...
  buyPrice: number;
  sellPrice: number;
  assetAccountId: string; // Linked Asset (Persediaan, e.g., "1-1400")
  salesAccountId: string; // Linked Sales Revenue (Penjualan, e.g., "4-1100")
  cogsAccountId: string;  // Linked Cost of Sales (HPP, e.g., "5-1100")
  createdAt: string;
}
